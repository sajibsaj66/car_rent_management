    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            CircleAvatar(
              backgroundImage: AssetImage('images/car-rental.png'),
              radius: 50.0,
            ),
            SizedBox(
              height: 20,
            ),
            Text('Project Car Rental',
              style: TextStyle(
                fontFamily: 'Pacifico',
                color: Colors.black,
            ...
            ListTile(
              leading: Image(image: AssetImage('images/logo.png'),height: 70,width: 70,),
                  ...
                  onPressed: () {
                    showAboutDialog(
                      ...
                      applicationIcon:Container(
                          ...
                          child: Image(image: AssetImage('images/logo.png'),height: 70,width: 70,)),
                      children: <Widget>[const Text('Car Rental is a one-stop digital health service solution for the people of Bangladesh.')],
                    );
                  },
                ),
              ),
            ...
            Padding(
              ...
              child: ListTile(
                  ...
                  onTap: () { launch('https://github.com/marufahmedofficial/car_rent_management');}
              ),
            ),
            Padding(
              padding: EdgeInsets.only(left: 25),
